...
public class Adcare extends BaseAdapter {
    ...
    public Adcare(ArrayList<DataServies> dataList, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        carddd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                ...
                Intent intent = new Intent(context, Datil_Mancur.class);
